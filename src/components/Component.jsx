...
const ImageGenerationForm = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const translationResponse = await fetch(`https://api.mymemory.translated.net/get?q=${input}&langpair=ro-RO|en-GB`);
  ...
  return (<div className="imageGPT container">
    <div className="container">
       <h1>Încurajează-ți creativitatea!</h1>
          <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Răsfoiți printr-o colecție de imagini imaginative și uimitoare din punct de vedere vizual generate de DALL-E AI</p>
      </div>
    ...
    {loading && <div className="loading"><p>
    <Audio
      height="80"
      width="80"
      radius="9"
    ...
    {!loading && output && (
      <div className="result-image">
        ...
        <div className="action">
            <button onClick={handleDownload}><BiDownload/></button>
            {user && <button onClick={uploadImage}><BiShare/></button>}
        </div>
      </div>
    )}
